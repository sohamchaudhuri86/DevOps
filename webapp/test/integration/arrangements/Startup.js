sap.ui.define([
	"sap/ui/test/Opa5",
	"DevOpsPOC/Fiori_Northwind/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("DevOpsPOC.Fiori_Northwind.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "DevOpsPOC.Fiori_Northwind",
					async: true
				},
				hash: oOptions.hash,
